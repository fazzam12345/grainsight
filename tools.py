...
def fast_process(
    annotations, args, mask_random_color, bbox=None, points=None, edges=False, contour_thickness=2
):
    ...
    if args.withContours == True:
        ...
        cv2.drawContours(temp, contour_all, -1, (255, 255, 255), contour_thickness)  # Using contour_thickness here
